...
namespace CodeGenerating
{
    internal abstract class CodegenBase
    {
        ...
        public MethodReference ImportReference(System.Reflection.MethodBase method) => Session.ImportReference(method);
        public MethodReference ImportReference(System.Reflection.MethodBase method, IGenericParameterProvider context) => Session.ImportReference(method, context);
        ...
        public FieldReference ImportReference(System.Reflection.FieldInfo field) => Session.ImportReference(field);
        public FieldReference ImportReference(System.Reflection.FieldInfo field, IGenericParameterProvider context) => Session.ImportReference(field, context);
